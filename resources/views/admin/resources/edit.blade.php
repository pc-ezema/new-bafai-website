...
@section('content')
    ...
    <form action="{{ route('admin.resources.update', $resource) }}" method="POST" enctype="multipart/form-data" id="resourceForm">
        @csrf @method('PUT')
        <div class="bg-white rounded-3 border p-4">
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        ...
                        @if($resource->file_path)
                            <div class="mb-2">
                                <a href="{{ asset('storage/'.$resource->file_path) }}" target="_blank" class="btn btn-sm btn-outline-secondary">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" name="external_url" class="form-control @error('external_url') is-invalid @enderror" value="{{ old('external_url', $resource->external_url) }}" placeholder="https://...">
                    ...
                    <div class="mb-3 form-check">
                        <input type="checkbox" name="is_published" class="form-check-input" id="isPublished" {{ old('is_published', $resource->is_published) ? 'checked' : '' }}>
            ...
            <div class="d-flex justify-content-end">
                <button type="submit" class="btn btn-primary" id="submitBtn">
                    ...
                    <span id="btnText"><i class="fas fa-save me-1"></i> Update Resource</span>
                </button>
            </div>
        </div>
    </form>
    ...
    <script>
        document.getElementById('resourceForm').addEventListener('submit', function() {
            ...
            document.getElementById('btnText').innerHTML = 'Updating...';
        });
    </script>
@endsection