...
@section('content')
        ...
        <div class="bg-white rounded-3 border p-4">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="author" class="form-control @error('author') is-invalid @enderror" value="{{ old('author', 'BAFAI') }}">
                        @error('author')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="d-flex justify-content-end">
                <button type="submit" class="btn btn-primary" id="submitBtn">
                    ...
                    <span id="btnText"><i class="fas fa-save me-1"></i> Save Post</span>
                </button>
            </div>
        </div>
    </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // If validation fails, re-enable button (since page reloads, this is not strictly needed)
            // But if you want to handle AJAX, you can add logic here.
        });
    </script>
@endsection